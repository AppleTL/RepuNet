...
def _execute_pd_game(pair: tuple[str, str], personas: dict[str, Persona], G: nx.Graph, save_folder: str, stats_collector, version:str):
    ...
    if "Refuse" in player1_decision or "Refuse" in player2_decision:
        ...
        # # add statistics
        # stats_collector.log_decision(player1.scratch.curr_step, player1.scratch.name, player1_strategy, version)
        # stats_collector.log_decision(player2.scratch.curr_step, player2.scratch.name, player2_strategy, version)
