...
def start_sign_up_without_gossip(personas, G, step, stats_collector, save_floder, sign_up_f=False):
    if sign_up_f:
...
def start_sign_up_without_gossip_with_publicreputation(personas, G, step, stats_collector, save_floder, sign_up_f=False):
    if sign_up_f:
        # sign up ever 5th step
        sign_up(personas, step, save_floder, G)
